...
<div class="w-full h-screen bg-gray-50 overflow-hidden">
  <AutoScrollViewPort scrollSpeed={30} edgeThreshold={40} smoothScroll={true}>
    ...
    <div class="absolute" style="left: 50px; top: 50px;">
      <Blocks id="block-1" zIndex={blockZIndices[0]} onSelect={() => bringToFront(0)}>
        <div class="p-4">
    ...
    <div class="absolute" style="left: 100px; top: 100px;">
      <Blocks id="block-2" zIndex={blockZIndices[1]} onSelect={() => bringToFront(1)}>
        <div class="p-4">
          ...
          <form class="space-y-3">
            ...
            <div>
              ...
              <input id="email" type="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
            </div>
    ...
    <div class="absolute" style="left: 150px; top: 150px;">
      <Blocks id="block-3" zIndex={blockZIndices[2]} onSelect={() => bringToFront(2)}>
        <div class="p-4">
